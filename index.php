...
<div id="wrap" class="">
    ...
    <div class="container">
        ...
        <p class="lead">Nullam sapien massa, aliquam in cursus ut, ullamcorper in tortor. 
Aliquam mauris arcu, tristique a lobortis vitae, condimentum feugiat justo.</p>
		<button class="btn btn-primary btn-lg"><a href="login.php" class="" a.visited="fff">Learn more..</a></button>
    </div>
</div>
